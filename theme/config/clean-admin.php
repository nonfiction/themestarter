...
add_action( 'current_screen', function( $screen ) {
  ...
  add_filter( 'edit_posts_per_page', function() { return 100; } );
  add_filter( 'edit_pages_per_page', function() { return 100; } );
  add_filter( "edit_{$screen->post_type}_per_page", function() { return 100; } );
} );
...
function hide_user_profile_sections( array $groups, array $roles = [] ) {
  ...
  if ( $roles && ! array_intersect( $roles, $user->roles ) ) { return; }
